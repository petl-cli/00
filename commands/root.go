...
import (
	...
	"github.com/example/asana/internal/telemetry"
...
var _configDir = func() string {
	...
	return filepath.Join(home, ".config", "asana")
}()
...
var rootCmd = &cobra.Command{
	Use:           "asana",
	Short:         "This is the interface for interacting with the [Asana Platform](https://developers.asana.com). Our API reference is generated from our [OpenAPI spec](https://raw.githubusercontent.com/Asana/openapi/master/defs/asana_oas.yaml).",
	Version:       "0.1.0",
