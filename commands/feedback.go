...
const (
	...
	feedbackToken    = "b2f87ad3-3cb1-4a74-948b-90bd5b7dcc14"
)
...
Examples:
  asana feedback "the --filter regex syntax is unclear"
  asana feedback --about "create-widget" "exit code 0 but no output"
`,
