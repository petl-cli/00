...
var tasksGetByCustomIdCmd = &cobra.Command{
	Use:   "get-by-custom-id",
	Short: "Get a task for a given custom ID",
	RunE:  runTasksGetByCustomId,
}

var tasksGetByCustomIdFlags struct {
	workspaceGid string
	customId     string
}

func init() {
	tasksGetByCustomIdCmd.Flags().StringVar(&tasksGetByCustomIdFlags.workspaceGid, "workspace-gid", "", "Globally unique identifier for the workspace or organization.")
	tasksGetByCustomIdCmd.MarkFlagRequired("workspace-gid")
	tasksGetByCustomIdCmd.Flags().StringVar(&tasksGetByCustomIdFlags.customId, "custom-id", "", "Generated custom ID for a task.")
	tasksGetByCustomIdCmd.MarkFlagRequired("custom-id")

	tasksCmd.AddCommand(tasksGetByCustomIdCmd)
}

func runTasksGetByCustomId(cmd *cobra.Command, args []string) error {
	...
	pathParams["workspace_gid"] = fmt.Sprintf("%v", tasksGetByCustomIdFlags.workspaceGid)
	pathParams["custom_id"] = fmt.Sprintf("%v", tasksGetByCustomIdFlags.customId)

	req := &httpclient.Request{
		Method:      "GET",
		Path:        httpclient.SubstitutePath("/workspaces/{workspace_gid}/tasks/custom_id/{custom_id}", pathParams),
