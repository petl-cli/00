...
var customFieldsDeleteFieldRecordCmd = &cobra.Command{
	Use:   "delete-field-record",
	Short: "Delete a custom field",
	RunE:  runCustomFieldsDeleteFieldRecord,
}

var customFieldsDeleteFieldRecordFlags struct {
	customFieldGid string
	optPretty      bool
}

func init() {
	customFieldsDeleteFieldRecordCmd.Flags().StringVar(&customFieldsDeleteFieldRecordFlags.customFieldGid, "custom-field-gid", "", "Globally unique identifier for the custom field.")
	customFieldsDeleteFieldRecordCmd.MarkFlagRequired("custom-field-gid")
	customFieldsDeleteFieldRecordCmd.Flags().BoolVar(&customFieldsDeleteFieldRecordFlags.optPretty, "opt-pretty", false, "Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")

	customFieldsCmd.AddCommand(customFieldsDeleteFieldRecordCmd)
}

func runCustomFieldsDeleteFieldRecord(cmd *cobra.Command, args []string) error {
	...
	pathParams["custom_field_gid"] = fmt.Sprintf("%v", customFieldsDeleteFieldRecordFlags.customFieldGid)
	...
	if cmd.Flags().Changed("opt-pretty") {
		req.QueryParams["opt_pretty"] = fmt.Sprintf("%v", customFieldsDeleteFieldRecordFlags.optPretty)
	}
