...
var userTaskListsGetUserTaskListCmd = &cobra.Command{
	Use:   "get-user-task-list",
	Short: "Get a user's task list",
	RunE:  runUserTaskListsGetUserTaskList,
}

var userTaskListsGetUserTaskListFlags struct {
	userGid   string
	optPretty bool
	workspace string
	optFields []string
...
func init() {
	userTaskListsGetUserTaskListCmd.Flags().StringVar(&userTaskListsGetUserTaskListFlags.userGid, "user-gid", "", "A string identifying a user. This can either be the string \"me\", an email, or the gid of a user.")
	userTaskListsGetUserTaskListCmd.MarkFlagRequired("user-gid")
	userTaskListsGetUserTaskListCmd.Flags().BoolVar(&userTaskListsGetUserTaskListFlags.optPretty, "opt-pretty", false, "Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")
	userTaskListsGetUserTaskListCmd.Flags().StringVar(&userTaskListsGetUserTaskListFlags.workspace, "workspace", "", "The workspace in which to get the user task list.")
	userTaskListsGetUserTaskListCmd.MarkFlagRequired("workspace")
	userTaskListsGetUserTaskListCmd.Flags().StringSliceVar(&userTaskListsGetUserTaskListFlags.optFields, "opt-fields", nil, "This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.")

	userTaskListsCmd.AddCommand(userTaskListsGetUserTaskListCmd)
}

func runUserTaskListsGetUserTaskList(cmd *cobra.Command, args []string) error {
	...
	pathParams["user_gid"] = fmt.Sprintf("%v", userTaskListsGetUserTaskListFlags.userGid)

	req := &httpclient.Request{
		Method:      "GET",
		Path:        httpclient.SubstitutePath("/users/{user_gid}/user_task_list", pathParams),
	...
	if cmd.Flags().Changed("opt-pretty") {
		req.QueryParams["opt_pretty"] = fmt.Sprintf("%v", userTaskListsGetUserTaskListFlags.optPretty)
	}
	if cmd.Flags().Changed("workspace") {
		req.QueryParams["workspace"] = fmt.Sprintf("%v", userTaskListsGetUserTaskListFlags.workspace)
	}
	if cmd.Flags().Changed("opt-fields") {
		req.ArrayParams["opt_fields"] = userTaskListsGetUserTaskListFlags.optFields
	}
