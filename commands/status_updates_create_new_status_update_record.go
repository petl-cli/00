...
var statusUpdatesCreateNewStatusUpdateRecordCmd = &cobra.Command{
	Use:   "create-new-status-update-record",
	Short: "Create a status update",
	RunE:  runStatusUpdatesCreateNewStatusUpdateRecord,
}

var statusUpdatesCreateNewStatusUpdateRecordFlags struct {
	optPretty bool
	limit     int
	offset    string
	optFields []string
...
func init() {
	statusUpdatesCreateNewStatusUpdateRecordCmd.Flags().BoolVar(&statusUpdatesCreateNewStatusUpdateRecordFlags.optPretty, "opt-pretty", false, "Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")
	statusUpdatesCreateNewStatusUpdateRecordCmd.Flags().IntVar(&statusUpdatesCreateNewStatusUpdateRecordFlags.limit, "limit", 0, "Results per page. The number of objects to return per page. The value must be between 1 and 100.")
	statusUpdatesCreateNewStatusUpdateRecordCmd.Flags().StringVar(&statusUpdatesCreateNewStatusUpdateRecordFlags.offset, "offset", "", "Offset token. An offset to the next page returned by the API. A pagination request will return an offset token, which can be used as an input parameter to the next request. If an offset is not passed in, the API will return the first page of results. *Note: You can only pass in an offset that was returned to you via a previously paginated request.*")
	statusUpdatesCreateNewStatusUpdateRecordCmd.Flags().StringSliceVar(&statusUpdatesCreateNewStatusUpdateRecordFlags.optFields, "opt-fields", nil, "This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.")
	statusUpdatesCreateNewStatusUpdateRecordCmd.Flags().StringVar(&statusUpdatesCreateNewStatusUpdateRecordFlags.data, "data", "", "")
	// Note: body fields are not MarkFlagRequired — --body JSON satisfies them too.
	statusUpdatesCreateNewStatusUpdateRecordCmd.Flags().StringVar(&statusUpdatesCreateNewStatusUpdateRecordFlags.body, "body", "", "Full request body as JSON (overrides individual flags)")

	statusUpdatesCmd.AddCommand(statusUpdatesCreateNewStatusUpdateRecordCmd)
}

func runStatusUpdatesCreateNewStatusUpdateRecord(cmd *cobra.Command, args []string) error {
	...
	if cmd.Flags().Changed("opt-pretty") {
		req.QueryParams["opt_pretty"] = fmt.Sprintf("%v", statusUpdatesCreateNewStatusUpdateRecordFlags.optPretty)
	}
	if cmd.Flags().Changed("limit") {
		req.QueryParams["limit"] = fmt.Sprintf("%v", statusUpdatesCreateNewStatusUpdateRecordFlags.limit)
	}
	if cmd.Flags().Changed("offset") {
		req.QueryParams["offset"] = fmt.Sprintf("%v", statusUpdatesCreateNewStatusUpdateRecordFlags.offset)
	}
	if cmd.Flags().Changed("opt-fields") {
		req.ArrayParams["opt_fields"] = statusUpdatesCreateNewStatusUpdateRecordFlags.optFields
	}
	...
	if statusUpdatesCreateNewStatusUpdateRecordFlags.body != "" {
		if err := json.Unmarshal([]byte(statusUpdatesCreateNewStatusUpdateRecordFlags.body), &bodyMap); err != nil {
	...
	if cmd.Flags().Changed("data") {
		bodyMap["data"] = statusUpdatesCreateNewStatusUpdateRecordFlags.data
	}
	req.Body = bodyMap
