...
var teamMembershipsGetRecordByIdCmd = &cobra.Command{
	Use:   "get-record-by-id",
	Short: "Get a team membership",
	RunE:  runTeamMembershipsGetRecordById,
}

var teamMembershipsGetRecordByIdFlags struct {
...
func init() {
	teamMembershipsGetRecordByIdCmd.Flags().StringVar(&teamMembershipsGetRecordByIdFlags.teamMembershipGid, "team-membership-gid", "", "")
	teamMembershipsGetRecordByIdCmd.MarkFlagRequired("team-membership-gid")
	teamMembershipsGetRecordByIdCmd.Flags().BoolVar(&teamMembershipsGetRecordByIdFlags.optPretty, "opt-pretty", false, "Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")
	teamMembershipsGetRecordByIdCmd.Flags().StringSliceVar(&teamMembershipsGetRecordByIdFlags.optFields, "opt-fields", nil, "This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.")

	teamMembershipsCmd.AddCommand(teamMembershipsGetRecordByIdCmd)
}

func runTeamMembershipsGetRecordById(cmd *cobra.Command, args []string) error {
	...
	pathParams["team_membership_gid"] = fmt.Sprintf("%v", teamMembershipsGetRecordByIdFlags.teamMembershipGid)

	req := &httpclient.Request{
		Method:      "GET",
		Path:        httpclient.SubstitutePath("/team_memberships/{team_membership_gid}", pathParams),
	...
	if cmd.Flags().Changed("opt-pretty") {
		req.QueryParams["opt_pretty"] = fmt.Sprintf("%v", teamMembershipsGetRecordByIdFlags.optPretty)
	}
	if cmd.Flags().Changed("opt-fields") {
		req.ArrayParams["opt_fields"] = teamMembershipsGetRecordByIdFlags.optFields
	}
