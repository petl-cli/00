...
var statusUpdatesGetRecordByIdCmd = &cobra.Command{
	Use:   "get-record-by-id",
	Short: "Get a status update",
	RunE:  runStatusUpdatesGetRecordById,
}

var statusUpdatesGetRecordByIdFlags struct {
...
func init() {
	statusUpdatesGetRecordByIdCmd.Flags().StringVar(&statusUpdatesGetRecordByIdFlags.statusUpdateGid, "status-update-gid", "", "The status update to get.")
	statusUpdatesGetRecordByIdCmd.MarkFlagRequired("status-update-gid")
	statusUpdatesGetRecordByIdCmd.Flags().BoolVar(&statusUpdatesGetRecordByIdFlags.optPretty, "opt-pretty", false, "Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")
	statusUpdatesGetRecordByIdCmd.Flags().StringSliceVar(&statusUpdatesGetRecordByIdFlags.optFields, "opt-fields", nil, "This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.")

	statusUpdatesCmd.AddCommand(statusUpdatesGetRecordByIdCmd)
}

func runStatusUpdatesGetRecordById(cmd *cobra.Command, args []string) error {
	...
	pathParams["status_update_gid"] = fmt.Sprintf("%v", statusUpdatesGetRecordByIdFlags.statusUpdateGid)
	...
	if cmd.Flags().Changed("opt-pretty") {
		req.QueryParams["opt_pretty"] = fmt.Sprintf("%v", statusUpdatesGetRecordByIdFlags.optPretty)
	}
	if cmd.Flags().Changed("opt-fields") {
		req.ArrayParams["opt_fields"] = statusUpdatesGetRecordByIdFlags.optFields
	}
