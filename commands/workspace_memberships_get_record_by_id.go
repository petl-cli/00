...
var workspaceMembershipsGetRecordByIdCmd = &cobra.Command{
	Use:   "get-record-by-id",
	Short: "Get a workspace membership",
	RunE:  runWorkspaceMembershipsGetRecordById,
}

var workspaceMembershipsGetRecordByIdFlags struct {
...
func init() {
	workspaceMembershipsGetRecordByIdCmd.Flags().StringVar(&workspaceMembershipsGetRecordByIdFlags.workspaceMembershipGid, "workspace-membership-gid", "", "")
	workspaceMembershipsGetRecordByIdCmd.MarkFlagRequired("workspace-membership-gid")
	workspaceMembershipsGetRecordByIdCmd.Flags().BoolVar(&workspaceMembershipsGetRecordByIdFlags.optPretty, "opt-pretty", false, "Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")
	workspaceMembershipsGetRecordByIdCmd.Flags().StringSliceVar(&workspaceMembershipsGetRecordByIdFlags.optFields, "opt-fields", nil, "This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.")

	workspaceMembershipsCmd.AddCommand(workspaceMembershipsGetRecordByIdCmd)
}

func runWorkspaceMembershipsGetRecordById(cmd *cobra.Command, args []string) error {
	...
	pathParams["workspace_membership_gid"] = fmt.Sprintf("%v", workspaceMembershipsGetRecordByIdFlags.workspaceMembershipGid)

	req := &httpclient.Request{
		Method:      "GET",
		Path:        httpclient.SubstitutePath("/workspace_memberships/{workspace_membership_gid}", pathParams),
	...
	if cmd.Flags().Changed("opt-pretty") {
		req.QueryParams["opt_pretty"] = fmt.Sprintf("%v", workspaceMembershipsGetRecordByIdFlags.optPretty)
	}
	if cmd.Flags().Changed("opt-fields") {
		req.ArrayParams["opt_fields"] = workspaceMembershipsGetRecordByIdFlags.optFields
	}
