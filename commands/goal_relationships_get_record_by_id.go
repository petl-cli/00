...
var goalRelationshipsGetRecordByIdCmd = &cobra.Command{
	Use:   "get-record-by-id",
	Short: "Get a goal relationship",
	RunE:  runGoalRelationshipsGetRecordById,
}

var goalRelationshipsGetRecordByIdFlags struct {
...
func init() {
	goalRelationshipsGetRecordByIdCmd.Flags().StringVar(&goalRelationshipsGetRecordByIdFlags.goalRelationshipGid, "goal-relationship-gid", "", "Globally unique identifier for the goal relationship.")
	goalRelationshipsGetRecordByIdCmd.MarkFlagRequired("goal-relationship-gid")
	goalRelationshipsGetRecordByIdCmd.Flags().BoolVar(&goalRelationshipsGetRecordByIdFlags.optPretty, "opt-pretty", false, "Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.")
	goalRelationshipsGetRecordByIdCmd.Flags().StringSliceVar(&goalRelationshipsGetRecordByIdFlags.optFields, "opt-fields", nil, "This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.")

	goalRelationshipsCmd.AddCommand(goalRelationshipsGetRecordByIdCmd)
}

func runGoalRelationshipsGetRecordById(cmd *cobra.Command, args []string) error {
	...
	pathParams["goal_relationship_gid"] = fmt.Sprintf("%v", goalRelationshipsGetRecordByIdFlags.goalRelationshipGid)
	...
	if cmd.Flags().Changed("opt-pretty") {
		req.QueryParams["opt_pretty"] = fmt.Sprintf("%v", goalRelationshipsGetRecordByIdFlags.optPretty)
	}
	if cmd.Flags().Changed("opt-fields") {
		req.ArrayParams["opt_fields"] = goalRelationshipsGetRecordByIdFlags.optFields
	}
